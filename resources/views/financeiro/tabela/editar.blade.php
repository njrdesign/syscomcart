        ...
        <section class="content">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Nova Tabela</h3>
            </div>
            {!! Form::model($tabelas, ['route' => ['tabela.update', $tabelas->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-4">
                         <div class="form-group @if($errors->first('emolumentos')) has-error @endif">
                             ...
                             {!! Form::text('emolumentos', null, ['class' => 'form-control', 'required' => 'required', 'data-thousands' => '.', 'data-decimal' => ',']) !!}
                     ...
                     <div class="col-sm-4">
                         <div class="form-group @if($errors->first('fdj')) has-error @endif">
                             ...
                             {!! Form::text('fdj', null, ['class' => 'form-control', 'required' => 'required', 'data-thousands' => '.', 'data-decimal' => ',']) !!}
                 ...
                 <div class="row">
                     <div class="col-sm-4">
                         <div class="form-group @if($errors->first('frmp')) has-error @endif">
                             ...
                             {!! Form::text('frmp', null, ['class' => 'form-control', 'required' => 'required', 'data-thousands' => '.', 'data-decimal' => ',']) !!}
                     ...
                     <div class="col-sm-4">
                         <div class="form-group @if($errors->first('fcrcpn')) has-error @endif">
                             ...
                             {!! Form::text('fcrcpn', null, ['class' => 'form-control', 'required' => 'required', 'data-thousands' => '.', 'data-decimal' => ',']) !!}
            ...
            <div class="box-footer">
                <a class="btn btn-danger" role="button" href="{{ URL::route('tabela') }}" aria-expanded="false">Cancelar</a>
